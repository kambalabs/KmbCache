...
{
    /** @var \KmbCache\Proxy\NodeStatisticsProxy */
    protected $nodeStatisticsProxyService;

    protected function setUp()
    {
        $cacheManager = $this->getMock('KmbCache\Service\NodeStatisticsCacheManager');
        ...
        $this->nodeStatisticsProxyService = new \KmbCache\Proxy\NodeStatisticsProxy();
